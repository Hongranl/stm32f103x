...
#define   ANDROID_DMA_TX_CH     DMA1_Channel7
#define   ANDROID_DMA_RX_CH     DMA1_Channel6

#define   ZIGBEE_DMA_TX_CH   DMA1_Channel2
#define   ZIGBEE_DMA_RX_CH   DMA1_Channel3
