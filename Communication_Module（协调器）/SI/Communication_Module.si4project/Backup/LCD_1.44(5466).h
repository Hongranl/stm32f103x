...
#define USE_HARDWARE_SPI2   
//#define USE_HARDWARE_SPI3 
...
//////////////////////////////////////////////////////////////////////
	...
	//液晶控制口置1操作语句宏定义
#define	LCD_1_44_CS_SET  		GPIOB->BSRR = GPIO_Pin_12 
#define	LCD_1_44_RS_SET  		GPIOC->BSRR = GPIO_Pin_7  
#define	LCD_1_44_SDA_SET  		GPIOB->BSRR = GPIO_Pin_15 
#define	LCD_1_44_SCL_SET  		GPIOB->BSRR = GPIO_Pin_13  
#define	LCD_1_44_RST_SET  		GPIOC->BSRR = GPIO_Pin_6
	//#define	LCD_LED_SET  	LCD_CTRL->BSRR=LCD_LED   

	//液晶控制口置0操作语句宏定义
#define	LCD_1_44_CS_CLR  		GPIOB->BRR = GPIO_Pin_12  
#define	LCD_1_44_RS_CLR  		GPIOC->BRR = GPIO_Pin_7    
#define	LCD_1_44_SDA_CLR  		GPIOB->BRR = GPIO_Pin_15   
#define	LCD_1_44_SCL_CLR  		GPIOB->BRR = GPIO_Pin_13   
#define	LCD_1_44_RST_CLR  		GPIOC->BRR = GPIO_Pin_6
