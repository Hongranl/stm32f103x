...
{   
  ...
  USART_ITConfig(USART2, USART_IT_IDLE, ENABLE);  //串口1空闲中断
	...
	MYDMA_Config( UART2_DMA_RX_CH,(u32)&USART2->DR,(u32)UART2_android_st.RXcun,UART_RX_LEN ,DMA_DIR_PeripheralSRC,DMA_Mode_Normal);//DMA1通道4,外设为串口1,存储器为UART1_SDBuff,长度USART1_SD_LEN. 
	...
	memset((u8*)&UART2_android_st, FALSE,sizeof(UART2_android_st));//标志位  全部为 FALSE
