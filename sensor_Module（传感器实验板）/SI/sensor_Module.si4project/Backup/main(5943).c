...
//	SHT1x_Config();
	...
	LCD_1_44_Clear(BLACK); //清屏
		...
		LCD_1_44_ShowNum2412(5+48,25,RED,YELLOW,":34",24,1);

		Show_Str(5,50,YELLOW,YELLOW,"湿度     ％",24,1);
		LCD_1_44_ShowNum2412(5+48,50,YELLOW,YELLOW,":42",24,1);
		...
		LCD_1_44_ShowNum2412(5+48,100,GREEN,YELLOW,":1.2",24,1);
	while(1)
	{ 
		...
		switch (SwitchType)
		{
			...
			break;
			case 2:
				LCD_1_44_ClearS(BLACK,0,0,100,150);
