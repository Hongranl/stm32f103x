	 ...
	 {	
	 		switch (SwitchType)
			{
				case 0:
					{
						LCD_1_44_Clear(BLACK);
						Show_Str(5,25,RED,YELLOW,"这是 0",24,1);
					}	
				break;
				case 1:
					{
						LCD_1_44_Clear(BLACK);
						Show_Str(5,25,RED,YELLOW,"这是 1",24,1);
					}	
				break;
				case 2:
					{
						LCD_1_44_Clear(BLACK);
						Show_Str(5,25,RED,YELLOW,"这是 2",24,1);
				}
				...
				case 3:
					{
						LCD_1_44_Clear(BLACK);
						Show_Str(5,25,RED,YELLOW,"这是 3 ",24,1);
						...
						sprintf(disp, ":%.0f",sensorData.temp);
						Show_Str(5,50,RED,YELLOW,"温度      ℃",24,1);
						LCD_1_44_ShowNum2412(5+48,50,RED,YELLOW,(uint8_t *)disp,24,1);
							
						sprintf(disp, ":%.0f",sensorData.hum);
						Show_Str(5,75,YELLOW,YELLOW,"湿度      ％",24,1);
						LCD_1_44_ShowNum2412(5+48,75,YELLOW,YELLOW,(uint8_t *)disp,24,1);
				...
				case 4:
					{
						LCD_1_44_Clear(BLACK);
						Show_Str(5,25,GREEN,YELLOW,"这是 4 ",24,1);
								/*温湿度传感器测试*/
				...
				case 5:
					{
						LCD_1_44_Clear(BLACK);
						Show_Str(5,25,RED,YELLOW,"这是 5 ",24,1);
					}	
				...
				case 6:
					{
						LCD_1_44_Clear(BLACK);
						Show_Str(5,25,RED,YELLOW,"这是 6 ",24,1);
					}	
				...
				case 7:
					{
						LCD_1_44_Clear(BLACK);
						Show_Str(5,25,RED,YELLOW,"这是 7 ",24,1);
					}	
				...
				case 8:
					{
						LCD_1_44_Clear(BLACK);
						Show_Str(5,25,RED,YELLOW,"这是 8 ",24,1);
					}	
				...
				case 9:
					{
						LCD_1_44_Clear(BLACK);
						Show_Str(5,25,RED,YELLOW,"这是 9 ",24,1);
					}	
