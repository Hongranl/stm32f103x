...
//////////////////////////////////////////////////////////////////////
	...
	//液晶控制口置1操作语句宏定义
#define	LCD_1_44_CS_SET  		PBout(12)=1
#define	LCD_1_44_RS_SET  		PCout(7) =1
#define	LCD_1_44_SDA_SET  		PBout(15)=1
#define	LCD_1_44_SCL_SET  		PBout(13)=1
#define	LCD_1_44_RST_SET  		PCout(6) =1
	//#define	LCD_LED_SET  	LCD_CTRL->BSRR=LCD_LED   

	//液晶控制口置0操作语句宏定义
#define	LCD_1_44_CS_CLR  		PBout(12)=0
#define	LCD_1_44_RS_CLR  		PCout(7) =0
#define	LCD_1_44_SDA_CLR  		PBout(15)=0
#define	LCD_1_44_SCL_CLR  		PBout(13)=0
#define	LCD_1_44_RST_CLR  		PCout(6) =0
