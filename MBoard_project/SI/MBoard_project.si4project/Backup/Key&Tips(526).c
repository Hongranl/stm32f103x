...
void keyInit(void){	
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8 | GPIO_Pin_9;	//端口属性分配
	...
	switch(Moudle_GTA.Extension_ID){
		...
		case MID_EXEC_DEVPWM:{
			...
			/*自定义数据处理↓↓↓↓↓↓↓↓↓↓↓↓*/
				...
				//mptr->mADDR = pwmDevMID_unvarLight;取消切换模式
	...
	switch(Moudle_GTA.Extension_ID){
		...
		case MID_EXEC_DEVPWM:{
			...
			/*自定义数据处理↓↓↓↓↓↓↓↓↓↓↓↓*/
				...
				//mptr->mADDR = pwmDevMID_varLight;取消切换模式
	...
	switch(Moudle_GTA.Extension_ID){
		...
		case MID_EXEC_DEVPWM:{
			...
			/*自定义数据处理↓↓↓↓↓↓↓↓↓↓↓↓*/
				...
				//mptr->mADDR = pwmDevMID_unvarFan;取消切换模式
