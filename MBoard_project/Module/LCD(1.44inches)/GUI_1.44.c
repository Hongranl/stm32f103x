 ...
 * @Module:     GUI_1.44
 * @Author:     RanHongLiang
 * @Date:       2019-07-03 10:10:23
 * @Description: 
 *————1.44屏的基本显示驱动函数
 *---------------------------------------------------------------------------*/

#include "LCD_1.44.h"//基本显示驱动函数；
#include "FONT_1.44.h" 
#include "string.h"

extern uint16_t LCD144POINT_COLOR,LCD144BACK_COLOR;
/*---------------------------------------------------------------------------
 * @Description: GUI描绘一个点
 * @Param:       x:光标位置x坐标，y:光标位置y坐标，color:要填充的颜色
 * @Return:     无
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
 * @Description:在指定区域内填充颜色
 * @Param:       sx:指定区域开始点x坐标,sy:指定区域开始点y坐标
 * 		ex:指定区域结束点x坐标,ey:指定区域结束点y坐标,color:要填充的颜色
 * @Return:     无
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
 * @Description:8对称性画圆算法(内部调用)
 * @Param:      (xc,yc) :圆中心坐标,(x,y):光标相对于圆心的坐标,c:填充的颜色
 * @Return:     无
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
 * @Description:在指定位置画一个指定大小的圆(填充)
 * @Param:      (xc,yc) :圆中心坐标,c:填充的颜色,r:圆半径
 ...
 * @Param:      (x,y):字符显示位置起始坐标,fc:前置画笔颜色,bc:背景颜色,num:数值（0-94）
 * 		size:字体大小, mode:模式  0,填充模式;1,叠加模式
 * @Return:     无
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
 * @Description:显示英文字符串
 * @Param:      x,y :起点坐标	size:字体大小   *p:字符串起始地址,
...
/*---------------------------------------------------------------------------
 * @Description:显示单个数字变量值
 * @Param:      x,y :起点坐标,len :指定显示数字的位数,size:字体大小(12,16),
 * 		color:颜色,num:数值(0~4294967295)
 * @Return:     无
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
 * @Description:显示单个16X16中文字体
 * @Param:      fc:前置画笔颜色,bc:背景颜色,s:字符串地址
 *		mode:模式	0,填充模式;1,叠加模式
 * @Return:     无
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
 * @Description: 显示一个字符串,包含中英文显示
 * @Param:      x,y :起点坐标,fc:前置画笔颜色,bc:背景颜色,str :字符串,size:字体大小
 *		mode:模式	0,填充模式;1,叠加模式
 * @Return:     无
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
 * @Description:显示一副16位BMP图像
 * @Param:       x,y :起点坐标,*p :图像数组起始地址
 * @Return:     无
 *---------------------------------------------------------------------------*/
