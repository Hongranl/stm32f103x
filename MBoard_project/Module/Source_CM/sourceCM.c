 ...
 * @Module:     sourceCM
 * @Author:     RanHongLiang
 * @Date:       2019-07-12 14:14:53
 * @Description: 
 * ————智能电表，采用DLT645-2007，具体些参考附件《单相智能电表——DL/T645-2007协议》
 * 	默认RS485 1200bps（9600B）
 * ---------------------------------------------------------------------------*/
 ...
 * @Param:      buf:发送区首地址，len:发送的字节数(为了和本代码的接收匹配,这里建议不要超过64个字节)
 * @Return:     无
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
 * @Description:这是预留的串口事件回调，例如 接收/发送 完成，接收/发送 错误等
 * @Param:      无
 * @Return:     无
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
 * @Description:串口初始化，采用库函数结构体注册初始化
 * @Param:      booter 串口波特率
 * @Return:     无
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
 * @Description:8bit校验和计算
 * @Param:      dats [ ] 数组，length长度
 * @Return:     8bit校验和
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
 * @Description:读取数据，转换为ID号
 * @Param:      *data 源数据, *id转换结果存放
 * @Return:     函数成功返回
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------
 * @Description:BCD码转换为HEX，源数据实际上做了 加0x33 的偏移
 * @Param:      data 源数据
 * @Return:     转换结果
 *---------------------------------------------------------------------------*/
