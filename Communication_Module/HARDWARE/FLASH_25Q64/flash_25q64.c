...
void SPI1_Init(void)
{
	...
	GPIO_SetBits(GPIOA,GPIO_Pin_5 | GPIO_Pin_6 | GPIO_Pin_7);  //GPIO_Pin_5 | GPIO_Pin_6 | GPIO_Pin_7上拉
...
u8 datatemp[SIZE];
SPI_Flash_Write((u8*)TEXT_Buffer,0,SIZE);		//从倒数第100个地址处开始,写入SIZE长度的数据
SPI_Flash_Read(datatemp,0,SIZE);			      	//从倒数第100个地址处开始,读出SIZE个字节
*/
