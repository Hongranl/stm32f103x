...
void sourceCM_Thread(const void *argument){
	...
	unsigned char send_buff[24]	= {0x68 ,
									...
									0x00,
									0x16};
	unsigned char t1111[24] = {0xFE, 0xFE, 0xFE, 0xFE, 0x68, 0x94, 0x41, 0x03, 0x26, 0x12, 0x18, 0x68, 0x91, 0x08, 0x33, 0x33, 0x34, 0x33, 0x59, 0x33, 0x33, 0x33, 0x50, 0x16 };
...
//		memcpy(RS485_RX_BUF,t1111,24);
//		RS485_RX_CNT = RS485_RX_BUF[13]+16;
//					
//		actuatorData.power_v = RS485_RX_CNT;
//		mptr->power_A	=  ADD_CHECK_8b(RS485_RX_BUF+4,RS485_RX_CNT-6);
//		osDelay(20);
...
//		osDelay(10);
	...
	//未获取ID
		...
		else//以获取ID
		{
			...
			osDelay(200);
			RS485_Send_Data(RS485_RX_BUF,16+8);
			
			osDelay(200);
			
			RS485_RX_CNT = RS485_RX_BUF[13]+16;
			
			RS485_Send_Data(&RS485_RX_CNT,1);
			osDelay(20);
			RS485_Send_Data(&(RS485_RX_BUF[RS485_RX_CNT-2]),1);
			osDelay(20);
			buff = ADD_CHECK_8b(RS485_RX_BUF+4,RS485_RX_CNT-6);
			RS485_Send_Data(&buff,1);
			osDelay(20);
			if(RS485_RX_BUF[RS485_RX_CNT-2] == ADD_CHECK_8b(RS485_RX_BUF+4,RS485_RX_CNT-6))
			{
				actuatorData.power_kwh = 
