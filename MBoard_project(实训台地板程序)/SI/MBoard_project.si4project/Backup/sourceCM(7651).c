		...
		else//以获取ID
		{
			...
			if(RS485_RX_CNT > 0 && RS485_RX_BUF[RS485_RX_CNT - 2] == ADD_CHECK_8b(RS485_RX_BUF+4,RS485_RX_CNT - 2 -4))
			{
				actuatorData.power_kwh = 
					((RS485_RX_CNT[18]-0x33)>>4 *10 + (RS485_RX_CNT[18]-0x33)&0x0f) + 
					((RS485_RX_CNT[19]-0x33)>>4 *10 + (RS485_RX_CNT[18]-0x33)&0x0f)*10 +
					((RS485_RX_CNT[20]-0x33)>>4 *10 + (RS485_RX_CNT[18]-0x33)&0x0f)*100+
					((RS485_RX_CNT[21]-0x33)>>4 *10 + (RS485_RX_CNT[18]-0x33)&0x0f)*1000;
			}
			//获取电压
			...
			if(RS485_RX_CNT > 0 && RS485_RX_BUF[RS485_RX_CNT - 2] == ADD_CHECK_8b(RS485_RX_BUF+4,RS485_RX_CNT - 2 -4))
			{
				actuatorData.power_kwh = 
					...
					((RS485_RX_CNT[20]-0x33)>>4 *10 + (RS485_RX_CNT[18]-0x33)&0x0f)*100+
					((RS485_RX_CNT[21]-0x33)>>4 *10 + (RS485_RX_CNT[18]-0x33)&0x0f)*1000+
					((RS485_RX_CNT[22]-0x33)>>4 *10 + (RS485_RX_CNT[18]-0x33)&0x0f)*1000+
					((RS485_RX_CNT[23]-0x33)>>4 *10 + (RS485_RX_CNT[18]-0x33)&0x0f)*10000;
			}
		}
