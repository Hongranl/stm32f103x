...
LEDstatus led1_last = led1_g,led1_status = led1_g;
LEDstatus led2_last = led1_r,led2_status = led1_r;
LEDstatus led3_last = led1_r,led3_status = led1_r;
...
void tipsInit(void){
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3 | GPIO_Pin_6  | GPIO_Pin_7 | GPIO_Pin_10 | GPIO_Pin_13;	//底板指示灯
