...
void MoudleDEC_ioInit(void){		//模块检测脚初始化
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4;		//Moudle_Check引脚初始化
