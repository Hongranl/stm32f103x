...
#define Relay1	PAout(8)		//Relay使能
#define Relay2	PCout(9)
#define Relay3	PCout(8)
#define Relay4	PCout(7)
#define Relay5	PCout(6)
#define Relay6	PBout(15)
#define Relay7	PBout(14)
#define Relay8	PBout(13)
