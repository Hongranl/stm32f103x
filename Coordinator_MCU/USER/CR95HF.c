	...
	{ 
		...
		switch(TagType)
		{
			case TRACK_NFCTYPE1:
			{
				...
				if( ANDROID_DEST_ADDR != 0 )
				{
					TRAN_info1.dest_addr[0]=ANDROID_DEST_ADDR;
					TRAN_info1.dest_addr[1]=(u8)(ANDROID_DEST_ADDR>>8);
					TRAN_info1.dest_addr[2]=(u8)(ANDROID_DEST_ADDR>>16);
					TRAN_info1.dest_addr[3]=(u8)(ANDROID_DEST_ADDR>>24);				 
				}
				else
				{
			...
			{			 
				...
				TRAN_info1.TYPE_NUM=4;
				TRAN_info1.data_len= 8+2;//ISO14443A_Card.UIDsize;  //4
