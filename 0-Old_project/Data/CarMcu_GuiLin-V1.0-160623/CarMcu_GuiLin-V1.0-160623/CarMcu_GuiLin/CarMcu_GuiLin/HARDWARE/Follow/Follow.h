...
#define CarTurnLeft0()		{  servoTurn = SERVO_TURN_L1; SetSever_PWMDuty(72); }  //add
#define CarTurnMiddle()		{  servoTurn = SERVO_TURN_M;  SetSever_PWMDuty(75); }
#define CarTurnRight0()		{  servoTurn = SERVO_TURN_R1; SetSever_PWMDuty(78); }  //add
...
#define CarTurnRight3()		{  servoTurn = SERVO_TURN_R3; SetSever_PWMDuty(102); }  //110
...
#define CarTurnRight3()		{  servoTurn = SERVO_TURN_R3; SetSever_PWMDuty(105); }  //95
...
#define CarTurnRight1()		{  servoTurn = SERVO_TURN_R1; SetSever_PWMDuty(85); }
#define CarTurnRight2()		{  servoTurn = SERVO_TURN_R2; SetSever_PWMDuty(95); }
#define CarTurnRight3()		{  servoTurn = SERVO_TURN_R3; SetSever_PWMDuty(102);}  

#else

#define CarTurnLeft3()		{  servoTurn = SERVO_TURN_L3; SetSever_PWMDuty(40); } //35
#define CarTurnLeft2()		{  servoTurn = SERVO_TURN_L2; SetSever_PWMDuty(60); }
#define CarTurnLeft1()		{  servoTurn = SERVO_TURN_L1; SetSever_PWMDuty(70); }
#define CarTurnLeft0()		{  servoTurn = SERVO_TURN_L1; SetSever_PWMDuty(72); }        //add
#define CarTurnMiddle()		{  servoTurn = SERVO_TURN_M;  SetSever_PWMDuty(75); }
#define CarTurnRight0()		{  servoTurn = SERVO_TURN_R1; SetSever_PWMDuty(78); }       //add
#define CarTurnRight1()		{  servoTurn = SERVO_TURN_R1; SetSever_PWMDuty(85); }  //90
#define CarTurnRight2()		{  servoTurn = SERVO_TURN_R2; SetSever_PWMDuty(95); }  //100
#define CarTurnRight3()		{  servoTurn = SERVO_TURN_R3; SetSever_PWMDuty(102);} //115
