...
//	RoadID    Left		Mider	Right
	{RID1,	1000,	2000,	1000},	//1000  2000 1000
	{RID2,	2000,	2000,	2000},	
	{RID3,	2000,	500,	2000},	//2000,	2000,	2000
	{RID4,	2000,	2000,	2000},	
	{RID5,	2000,	2000,	2000},	//2000,	2000,	2000
	{RID6,	2000,	2000,	2000},	
	{RID7,	2000,	2000,	2000},	
	{RID8,	2000,	2000,	1000},	//   2000
	{RID9,	1000,	2000,	2000},	//    500  1,2,4号车     1000 3,5号车
			...
			if(LastCardID != NewCardID)
			{
				...
				{ 
					...
					if(temp)		
					{
						if(temp==0xff)
						{
							if(NewCardID == RID21)   // Flags = 1;		//add 5-19				
							{
								CarStop2();		
								//OSTimeDlyHMSM(0,0,2,0);
								//CarStar2();
