...
{  
	...
	u16	i = 0;
	static u16 crc_buff=0;
	u8  dat[8] = { 01,03, 00 ,0x48, 00 ,05 ,05 ,0xdf }; 

	u8  dat1[8] = { 01,03, 00 ,0x48, 00 ,05 ,05 ,0xdf };
	u8 test_buf[22]={0xaa,0xaa,0x4b,0x00,0x15,0x00,0x00,0x00,0x01,0x00,0x14, 0x00,0x00,0x00,0x01,0x02,0x03,0x00,0x03, 0x00,0xbb,0xbb};
	...
	*/	
	...
	crc_buff = Rs485_COMM_crc8(test_buf,22);
