...
{   
  ...
  MYDMA_Config( RS485_COMM_DMA_RX_CH,(u32)&USART2->DR,(u32)UART2_RS485_COMM_st.RXcun,UART_RX_LEN ,DMA_DIR_PeripheralSRC,DMA_Mode_Normal);//DMA1通道4,外设为串口1,存储器为UART1_SDBuff,长度USART1_SD_LEN. 
