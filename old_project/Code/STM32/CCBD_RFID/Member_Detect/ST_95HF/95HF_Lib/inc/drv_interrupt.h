 ...
 */
#define EXTI_RFTRANS_95HF_PIN        				GPIO_Pin_10
#define EXTI_GPIO_PORT       			      		GPIOA
#define EXTI_RFTRANS_95HF_PIN_SOURCE        		GPIO_PinSource10
#define EXTI_RFTRANS_95HF_GPIO_CLOCK				RCC_APB2Periph_GPIOA
#define EXTI_RFTRANS_95HF_GPIO_PORT_SOURCE			GPIO_PortSourceGPIOA
#define EXTI_RFTRANS_95HF_LINE						EXTI_Line10


/**
 * @brief  IRQout Interface pin PA2
 */
#define IRQOUT_RFTRANS_95HF_PIN        				GPIO_Pin_9
#define IRQOUT_RFTRANS_95HF_PIN_SOURCE        		GPIO_PinSource9
...
#define RFTRANS_95HF_IRQIN_LOW() 				GPIO_ResetBits(GPIOA, GPIO_Pin_9);
#define RFTRANS_95HF_IRQIN_HIGH()  				GPIO_SetBits(GPIOA, GPIO_Pin_9);
