...
//86开关灯面板2路 	55
//86开关灯面板3路 	56 
#define  DTN_86_LIGHT_1          0x36     
#define  DTN_86_LIGHT_2          0x37
#define  DTN_86_LIGHT_3          0x38
#define  DTN_86_SENSOR_MQ        0x39
#define  DTN_86_SENSOR_body      0x3A

#define  SENSOR_tem_hum_light      0x3B
#define  SENSOR_tem_LEN      0x1c//16+12
...
#define KEY 	  (((GPIOA->IDR & Pin(2) )== 0 ) ? 1 : 0 )// (GPIOA->IDR & Pin(2) )
#define LED(a) 		(a==1)?( GPIOA->ODR &= ~ Pin(3) ):( GPIOA->ODR |= Pin(3) ) 
...
#define LED(a) 		(a==1)?( GPIOA->ODR &= ~ Pin(3) ):( GPIOA->ODR |= Pin(3) ) 
#define BEEP_s(a) 	(a==0)?( GPIOC->ODR &= ~ Pin(7) ):( GPIOC->ODR |= Pin(7) ) 
...
#define LED(a) 		(a==1)?( GPIOC->ODR &= ~ Pin(7) ):( GPIOC->ODR |= Pin(7) ) 
#endif
