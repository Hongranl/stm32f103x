...
//IO方向设置
#define TSLSDA_IN()  {GPIOB->DDR &=~ GPIO_PIN_5;}//输入模式
#define TSLSDA_OUT() {GPIOB->DDR |= GPIO_PIN_5;}//输入模式

//IO操作函数	 
#define TSLIIC_SCL    PBout(4) //SCL
#define TSLIIC_SDA    PBout(5) //SDA	 
#define TSLREAD_SDA   PBin(5)  //SDA

#define delay_us(a)    Delay(a)
