...
#define SHT10_DATA_H()        GPIO_WriteHigh(SHT10_DATA_PORT, SHT10_DATA_PIN)                         //拉高DATA数据线
#define SHT10_DATA_L()        GPIO_WriteLow(SHT10_DATA_PORT, SHT10_DATA_PIN)                          //拉低DATA数据线
#define SHT10_DATA_R()       GPIO_ReadInputPin(SHT10_DATA_PORT, SHT10_DATA_PIN)        				  //读DATA数据线

#define SHT10_SCK_H()        GPIO_WriteHigh(SHT10_SCK_PORT, SHT10_SCK_PIN)                        	  //拉高SCK时钟线
#define SHT10_SCK_L()        GPIO_WriteLow(SHT10_SCK_PORT, SHT10_SCK_PIN)                        	  //拉低SCK时钟线
...
extern void SHT1X_Config(void);
extern u8 SHT1X_GetValue(u16*temp_val,u16*humi_val,float*temp_val_real,float*humi_val_real);
